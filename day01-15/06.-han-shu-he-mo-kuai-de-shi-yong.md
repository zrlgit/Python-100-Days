...
![x\_1 + x\_2 + x\_3 + x\_4 = 8](../Day01-15/res/formula\_3.png)

事实上，上面的问题等同于将8个苹果分成四组每组至少一个苹果有多少种方案。想到这一点问题的答案就呼之欲出了。

![C\_M^N =\frac{M!}{N!(M-N)!}, \text{(M=7, N=3)}](../Day01-15/res/formula\_4.png)
