...
4. 2000年10月16日：Python 2.0发布，增加了完整的[垃圾回收](https://zh.wikipedia.org/wiki/%E5%9E%83%E5%9C%BE%E5%9B%9E%E6%94%B6\_\(%E8%A8%88%E7%AE%97%E6%A9%9F%E7%A7%91%E5%AD%B8\))，提供了对[Unicode](https://zh.wikipedia.org/wiki/Unicode)的支持。与此同时，Python的整个开发过程更加透明，社区对开发进度的影响逐渐扩大，生态圈开始慢慢形成。
...
4. 修改用户主目录下名为.bash\_profile的文件，配置PATH环境变量并使其生效。
...
PyCharm的安装、配置和使用在[《玩转PyCharm》](../fan-wai-pian/wan-zhuan-pycharm.md)进行了介绍，有兴趣的读者可以选择阅读。
